        ...
        var t,
          ...
          o = d("paint", function (e) {
            e.forEach(function (e) {
              "first-contentful-paint" === e.name && (o.disconnect(), e.startTime < r.firstHiddenTime && (i.value = Math.max(e.startTime - s(), 0), i.entries.push(e), t(true)));
            });
          });
  ...
  return e.CLSThresholds = w, e.FCPThresholds = S, e.FIDThresholds = X, e.INPThresholds = O, e.LCPThresholds = j, e.TTFBThresholds = _, e.onCLS = function (e, n) {
    ...
    n = n || {}, L(function () {
      var i,
        ...
        u = f("FID"),
        s = function (e) {
          e.startTime < a.firstHiddenTime && (u.value = e.processingStart - e.startTime, u.entries.push(e), i(true));
        },
        p = function (e) {
          e.forEach(s);
        },
    ...
    n = n || {}, L(function () {
      ...
      if (a) {
        ...
        var u = m(function () {
          V[i.id] || (o(a.takeRecords()), a.disconnect(), V[i.id] = true, t(true));
        });
        ["keydown", "click"].forEach(function (e) {
          ...
          i = f("LCP"), t = l(e, i, j, n.reportAllChanges), p(function () {
            i.value = performance.now() - r.timeStamp, V[i.id] = true, t(true);
          });
        });
      }
    });
    ...
    z(function () {
      var i = u();
      i && (t.value = Math.max(i.responseStart - s(), 0), t.entries = [i], r(true), c(function () {
        t = f("TTFB", 0), (r = l(e, t, _, n.reportAllChanges))(true);
      }));
    });
  }, e;
})({});
