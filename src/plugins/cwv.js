...
(function (e) {
  ...
  function d(e, t) {
    let n = a.get(t);
    return n || (n = new WeakMap(), a.set(t, n)), n.get(e) || n.set(e, new t()), n.get(e);
  }
  class h {
    t;
    i = 0;
  ...
  const m = new Set(),
    ...
    v = () => {
      if (u < 0) {
        ...
        u = t ?? g(), addEventListener("visibilitychange", p, true), addEventListener("prerenderingchange", p, true), n(() => {
          setTimeout(() => {
            u = g();
          });
        });
  ...
  return e.CLSThresholds = E, e.FCPThresholds = T, e.INPThresholds = B, e.LCPThresholds = q, e.TTFBThresholds = N, e.onCLS = (e, t = {}) => {
    ...
    y(() => {
      ...
      o = i(e, r, B, t.reportAllChanges), l && (l.observe({
        ...
        a.v(), r = c("INP"), o = i(e, r, B, t.reportAllChanges);
      }));
    });
  }, e.onLCP = (e, t = {}) => {
    y(() => {
      ...
      script.onload = () => {
        const storeCWV = measurement => {
          ...
          if (measurement.name === 'CLS' && measurement.entries.length > 0) {
            const largest = measurement.entries.reduce((a, b) => b.value > (a ? a.value : 0) ? b : a, undefined);
            const node = largest && largest.sources && largest.sources.map(s => s.node).find(n => n && n.nodeType === 1);
            if (node) {
