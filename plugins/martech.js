 ...
 */
function addAdsParametersTracking(usp, { sampleRUM }) {
  const networks = {
...
function addEmailParameterTracking(usp, { sampleRUM }) {
  const networks = {
...
function addUTMParametersTracking(usp, { sampleRUM }) {
...
export function addMartechTraking({ sampleRUM }) {
  ...
  addUTMParametersTracking(usp, { sampleRUM });
}
